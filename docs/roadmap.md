...
当前优先交付能够运行、演示并解释价值的成品，使用现有 GitHub 保存项目材料。Company 归档与云资源选型不作为本阶段前置条件；冻结架构与真实设备验证语义保留。当前范围及唯一下一步见[阶段决定](v0.2/reviews/2026-09-08-demonstrable-product-priority.md)。
