...
| Artifact retention/expires 未确认 | 在线 Artifact 未来可能不可访问 | Project Owner / Release Engineer | retention/expires 保持 `UNKNOWN`；在可访问窗口内复核，必要时按独立 Evidence Archive 流程固定 |
